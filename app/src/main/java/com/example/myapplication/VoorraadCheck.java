...
public class VoorraadCheck extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.voorraadcheck);

        helper = new DatabaseHelper(this);
        listView = findViewById(R.id.listViewVoorraad);

        HashMap<String, Integer> itemStock = new HashMap<>();
        ...
        if(allItems.getCount() == 0){
            ...
            while(allItems.moveToNext()){
                itemStock.put(allItems.getString(1), allItems.getInt(2));
            }
        }
